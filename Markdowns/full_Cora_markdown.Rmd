...
```{r echo=F, warning=F, message=F, fig.width=20, fig.height=20}
...
```{r comment='', warning=F}
cat(readLines('../../SMETS/results.txt'), sep = '\n')
```



Where s01 represents the SMETS distance between condition 0 and 1.
