...
```{r cache=TRUE}
plot.heat.save.figure <- function(data, meas.col, n, directory = "plot_heat_output/", save.table = F, ncolor = 20){
  require(gplots)
  # Got to matrix
...
temp <- replicate(2, sapply(conditions, function(x) plot.heat.save.figure(Yanni[Condition==x], "Ratio", n = 20, "../plot_heat_output/", ncolor = 30)))
